function Home_scene() {
    ...
    //
    //    //     miao_danmu("l.github.io/game2/index.html#buy-tab-德律商店")
    //    // }
    //    function buttons_init() {
    //            // console.log("onsss")
    //            $("#section-home-btn-load").click(function () {
    //                sys.to_scene("save", "load")
    //            })
    //            $("#section-home-btn-save").click(function () {
    //                sys.to_scene("save", "save")
    //            })
    //        }
    //        // $("#lidazhao_test").animate({left:'-97px'},function(){});
    //        // setInterval(function(){ alert("Hello"); }, 3000);
    //
    //    function tabs_init() {
    //        //tab_item_init();
    //        //        $('#home-main-tab a').on('shown.bs.tab', function (e) {
    //        //            save_object("current_tab", {
    //        //                content: $(e.target).attr("mytext")
    //        //            });
