...
###### products
name | material| instrument | difficulty|skill|summary
-----|---------|------------|-----------|-----|--------
单片机流水灯|低端单片机*1+LED*8+电路基础元件*1|万用表,逻辑分析仪|3|c语言v1|
硬件流水灯|五5伍*1+LED*8+电路基础元件*1|万用表|2|电路分析v1
单片机流水灯1|低端单片机*1+LED*8+电路基础元件*1|表?|10
单片机流水灯2|低端单片机*1+LED*8+电路基础元件*1|表?|10
单片机流水灯3|低端单片机*1+LED*8+电路基础元件*1|表?|10
单片机流水灯4|低端单片机*1+LED*8+电路基础元件*1|表?|10
单片机流水灯5|低端单片机*1+LED*8+电路基础元件*1|表?|10
单片机流水灯6|低端单片机*1+LED*8+电路基础元件*1|表?|10
...
低端示波器|示|1波器|oscilloscope|500|低端调试仪器，可以增加少许的调试速度|学校的旧实验室有一堆这种东西|1
