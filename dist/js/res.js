...
define(["system-common"], function (common) {
    ...
    var res_json_data = {
        ...
        "goodness": [{
            ...
            "contradiction": "none",
            "cost": "1",
            "summary": "在高中学习了过多的数学知识"
        }, {
            "name": "物理竞赛选手",
            "effect": "电路分析与微积分等级++",
            "contradiction": "none",
            "cost": "1",
            "summary": "在高中学习了过多的数学和物理知识"
        }, {
            "name": "信息竞赛选手",
            "effect": "编程相关技能等级++",
            "contradiction": "none",
            "cost": "1",
            "summary": "在高中学习了过多的计算机知识"
        }, {
            "name": "富二代",
            "effect": "每月生活费++",
            "contradiction": "穷二代",
            ...
            "contradiction": "none",
            "cost": "1",
            "summary": "每天都可以和喜欢的人在一起"
        }, {
            "name": "电二代",
            "effect": "基础电路技能++",
            "contradiction": "穷二代",
            "cost": "1",
            "summary": "父母是电子工程师,教过你不少知识"
        }, {
            "name": "学霸",
            "effect": "上课效率++",
        ...
        "characterCombine": [{
            ...
            "name": "竞赛狂人",
            "condition": "数学竞赛选手+物理竞赛选手+信息竞赛选手"
        }, {
            "name": "情圣",
            "condition": "异地恋+八面玲珑+交际花"
        }, {
            "name": "白马王子",
            "condition": "富二代+学霸+八面玲珑"
        }, {
            "name": "那个谁",
            "condition": "物理竞赛选手+穷二代+学渣+自闭症"
        }, {
            "name": "现充",
            "condition": "(同性恋||异地恋)+学生会成员-手办爱好者"
        }, {
            "name": "月光族",
            "condition": "穷二代,异地恋,手办爱好者"
        }, {
            "name": "主角",
            "condition": "富二代+电二代+八面玲珑+智商正常"
        }]
    };
            ...
            switch (table_name) {
                ...
                case "weakness":
                    ...
                    d.forEach(function (v, i) {
                        ...
                        var contradiction = someness[v.name].contradiction;
